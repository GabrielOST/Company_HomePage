      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="?sair"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> Sair</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9">
           ...
           <div class="col-md-3">
            <p><span class="glyphicon glyphicon-time" aria-hidden="true"></span> Seu ultimo login foi em: 12/06/2019</p>
          </div>
        </div>
      </div>
    </header>
...
<section class="principal">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><button id_membro="<?php echo $value['id']; ?>" type="button" class="deletar-membro btn btn-xs btn-danger">
    ...
    <script type="text/javascript">
      $(function(){
        ...
        //FUNÇÃO DE SELEÇÃO DE MENU E ALTERAÇÃO (REMOÇÃO E ADIÇÃO) DE CLASS COM "ref_sys"
          function cliqueMenu(){
          ...
          //Função scroll para direcionar ao item clicado no MENU
          function scrollItem(){
             $('#menu-principal a, .list-group a').click(function(){
                ...
                // Se a tela for menor que 768, fecha o menu mobile ao clicar na opção
